...
---------------------------------------------------------------------- constantes del programa
    ...
    constant tiempo_escritura:time :=8*tiempo_clk*1000;                  -- tiempo que tarda el módulo display en escribir en cada uno de los displays una vez
begin
---------------------------------------------------------------------- unidad bajo testeo
uut: display 
generic map(prescaler=>1000)
port map( 
        estado => estado,               
        monedero=> monedero,
        producto =>producto,
